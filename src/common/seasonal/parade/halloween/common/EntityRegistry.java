...
import seasonal.parade.halloween.client.EntityHeadless;
...
public class EntityRegistry{
	public static void registerEntities(){
		...
		cpw.mods.fml.common.registry.EntityRegistry.registerGlobalEntityID(EntityHeadless.class, "Headless Horseman", cpw.mods.fml.common.registry.EntityRegistry.findGlobalUniqueEntityId(), 0x111111, 0xE28D1C);
