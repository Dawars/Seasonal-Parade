...
public class RenderEvilPumpkin extends RenderLiving
{
    private int field_77120_a;

    public RenderEvilPumpkin()
    {
        super(new ModelMagmaCube(), 0.25F);
        this.field_77120_a = ((ModelMagmaCube)this.mainModel).func_78107_a();
    }

    public void renderMagmaCube(EntityEvilPumpkin par1EntityMagmaCube, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected void scaleMagmaCube(EntityEvilPumpkin par1EntityMagmaCube, float par2)
    {
    ...
    {
        this.scaleMagmaCube((EntityEvilPumpkin)par1EntityLiving, par2);
    }

    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderMagmaCube((EntityEvilPumpkin)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.renderMagmaCube((EntityEvilPumpkin)par1Entity, par2, par4, par6, par8, par9);
    }
}
