...
public class EntityEvilPumpkin extends EntitySlime
{
    public EntityEvilPumpkin(World par1World)
    {
        super(par1World);
        this.texture = "/seasonal/parade/halloween/gfx/mob/EvilPumpkin.png";
    }
    ...
    {
        return new EntityEvilPumpkin(this.worldObj);
    }
